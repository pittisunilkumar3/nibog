        ...
        <Tabs defaultValue="company" className="space-y-4">
          ...
          <TabsContent value="social" className="space-y-4">
            <Card>
              ...
              <CardContent className="space-y-4">
                {footerContent.socialMediaLinks.map((link, index) => (
                  <div key={link.id} className="flex items-center gap-4 p-4 border rounded-lg">
                    ...
                    <div className="flex-1">
                      <Input
                        value={link.url}
                        onChange={(e) => {
                          const updatedLinks = [...footerContent.socialMediaLinks]
                          updatedLinks[index] = { ...link, url: e.target.value }
                          updateFooterContent({ socialMediaLinks: updatedLinks })
                        }}
                    ...
                    <div className="flex items-center gap-2">
                      <Switch
                        ...
                        onCheckedChange={(checked) => {
                          const updatedLinks = [...footerContent.socialMediaLinks]
                          updatedLinks[index] = { ...link, enabled: checked }
                          updateFooterContent({ socialMediaLinks: updatedLinks })
                        }}
                      />
            ...
            <div className="grid gap-4 md:grid-cols-2">
                ...
                <CardContent className="space-y-3">
                      ...
                      <div className="flex-1 space-y-2">
                        <Input
                          ...
                          onChange={(e) => {
                            ...
                            updateFooterContent({ quickLinks: updatedLinks })
                          }}
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      updateFooterContent({
                        quickLinks: [...footerContent.quickLinks, newLink]
                      })
                    }}
                    className="w-full"
                  >
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Legal and policy links in the footer
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-3">
                    ...
                    <div key={link.id} className="flex items-center gap-2 p-3 border rounded-lg">
                      <div className="flex-1 space-y-2">
                        <Input
                          value={link.label}
                          onChange={(e) => {
                            const updatedLinks = [...footerContent.legalLinks]
                            updatedLinks[index] = { ...link, label: e.target.value }
                            updateFooterContent({ legalLinks: updatedLinks })
                          }}
                          placeholder="Link label"
                          className="text-sm"
                        />
                      ...
                      <div className="flex flex-col items-center gap-2">
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={() => {
                            const updatedLinks = footerContent.legalLinks.filter((_, i) => i !== index)
                            updateFooterContent({ legalLinks: updatedLinks })
                          }}
                        >
                          <Trash2 className="h-3 w-3" />
                  ...
                  <Button
                    ...
                    onClick={() => {
                      ...
                      updateFooterContent({
                        legalLinks: [...footerContent.legalLinks, newLink]
                      })
                    }}
                    className="w-full"
                  >
