    ...
    <div className="container py-12 md:py-16 lg:py-24">
      <div className="mx-auto max-w-3xl space-y-8">
        ...
        <div className="space-y-6">
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-semibold">3. Event Rescheduling</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-semibold">4. Event Cancellation by NIBOG</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-semibold">5. Refund Process</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-2xl font-semibold">6. Registration Transfers</h2>
            <p>
