          ...
          <div className="space-y-6 lg:col-span-2">
            ...
            <div className="flex space-x-4">
              ...
              {twitterUrl && twitterUrl !== "https://twitter.com" && (
                <Link href={twitterUrl} className="bg-gradient-to-br from-mint-400 to-mint-600 rounded-full p-3 shadow-lg hover:shadow-xl transform hover:scale-110 transition-all duration-300 animate-medal-shine" target="_blank" rel="noopener noreferrer">
                  <svg className="h-5 w-5 text-white" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
